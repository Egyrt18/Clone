...
void main() {
  String p = "28+2-3*6+9/5-4*6";
  final List<ExpressionDto> test = InputParser().parse(p);
  print(ExpressionHandler().calculateExpression(test));
  //runApp(MyApp());
}
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  void _calc() {
    setState(() {
      //  result = handler
      //    .calculateExpression(inputParser.parse(input) as List<ExpressionDto>);
    });
  }
